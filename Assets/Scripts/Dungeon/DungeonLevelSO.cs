...
public class DungeonLevelSO : ScriptableObject
{
    ...
    #region Tooltip
    [Tooltip("Populate teh list with the room templates that you want to be part of the level. You need to ensure that room templates are included for" +
    ...
    #region Tooltip
    [Tooltip("Populate this list with room node graphs which should be randomly selected from for the level")]
    #endregion Tooltip
